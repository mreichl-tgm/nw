...
\newglossaryentry{doppelspalt}{
	...
	description={Beim Doppelspaltexperiment wird kohärentes Licht durch zwei beieinanderliegende Spalte geschickt. An beiden Spalten entstehen neue Elementarwellen, welche sich überlagern und beim Auftreffen als Interferenzmuster aus hellen und dunklen Streifen dargestellt werden.}
}

%TODO: Ametropie, Myopie, Hyperopie, Astigmatismus, Glucose, Akkomodation